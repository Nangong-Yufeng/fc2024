...
class DropWayPointGen(WayPointShit):
    ...
    def get_info_from_input(self):
        ...
        self.output_wp_to_file("/home/joe/Desktop/way.txt", self.ret)
        
        # 生成投弹航线
        self.ret = self.gen_drop_waypoint(self.tg1_enu)
        self.output_wp_to_file("/home/joe/Desktop/way1.txt", self.ret)
        
        # 生成投弹航线
        self.ret = self.gen_drop_waypoint(self.tg2_enu)
        self.output_wp_to_file("/home/joe/Desktop/way2.txt", self.ret)
        
        # 生成投弹航线
        self.ret = self.gen_drop_waypoint(self.tg3_enu)
        self.output_wp_to_file("/home/joe/Desktop/way3.txt", self.ret)
