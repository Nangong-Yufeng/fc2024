...
# from utils.CompeitionWaypointA import DropWayPointGenA_V2
from utils.FinalWaypoint  import DropWayPointGenA_V2
...
class PlayGroundNode(WayPointShit, ParameterShit, RallyPointShit):
    ...
    def timer_cb(self):
        ...
        # print(self.control_state)
        if self.offboard_setpoint_counter <= 20:
            tmp = DropWayPointGenA_V2([31.8371110, 106.9440972, 0], [31.8374309, 106.9440512, 20], [31.8371777, 106.9440978, 20], [31.8372746, 106.9438774, 20])
            # print(tmp.rally)
